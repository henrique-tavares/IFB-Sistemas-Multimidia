...
export default class ToolShed extends BaseRoomInterior {
  ...
  create() {
    ...
    this.hanginglight = new HangingLight(
      this,
      this.screen.relativeX(49.9),
      this.screen.relativeY(5.2)
    );
    this.hanginglight.setDepth(this.screen.relativeY(100));

    const door = new Door(
      this,
      this.screen.relativeX(50.5),
      this.screen.relativeY(91.5),
      2,
    ...
    const rects = [
      ...
      new GameObjects.Rectangle(
        ...
        this.screen.relativeX(6),
        this.screen.relativeY(10)
      ),
      new GameObjects.Rectangle(
        this,
        this.screen.relativeX(76),
        this.screen.relativeY(53),
        this.screen.relativeX(6),
      ...
      new GameObjects.Rectangle(
        this,
        this.screen.relativeX(73),
        this.screen.relativeY(73),
        this.screen.relativeX(4),
        this.screen.relativeY(13)
      ),
      new GameObjects.Rectangle(
        this,
        this.screen.relativeX(30),
        this.screen.relativeY(76),
        this.screen.relativeX(8),
        this.screen.relativeY(15)
      ),
      new GameObjects.Rectangle(
        this,
        this.screen.relativeX(29.5),
        this.screen.relativeY(32),
        this.screen.relativeX(5.75),
        this.screen.relativeY(10)
      ),
    ];
    ...
    this.time.delayedCall(fadeDuration, () => {
      this.scene.run("dialog", {
        character: "Túlio",
        dialogs: ["Beleza, consegui chegar vivo.", "Agora, onde deixei meu revólver mesmo?"],
      });
    });
  }
