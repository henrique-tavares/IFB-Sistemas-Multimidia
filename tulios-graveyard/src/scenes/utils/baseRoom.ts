...
export default abstract class BaseRoom extends Phaser.Scene {
  ...
  protected borderConfig: BackgroundBorderConfig;
  ...
  private bulletsInScene = new Map<number, Bullet>();
  ...
  create() {
    this.bgBorder = {
      top: this.borderConfig.hasTop ? this.verticalPadding : undefined,
      right: this.borderConfig.hasRight ? this.horizontalPadding : undefined,
      bottom: this.borderConfig.hasBottom ? this.verticalPadding : undefined,
      left: this.borderConfig.hasLeft ? this.horizontalPadding : undefined,
    };
